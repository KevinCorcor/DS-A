...
{	
	...
	public static void main (String args[])
	{
    	...
    	//System.out.println("names:     means     		     vars   		        sds");
    	//	for(int c = 1; c<cols;c++)
	//	{
		//	System.out.println(names[c]+":	"+means[c]+" 	  "+vars[c]+"		"+sds[c]);
		//	}
    	...
    	//test
  			/*
    			invests[1]=3;
    			invests[2]=4;
    			double[] x=Stats.getSumProd(data, invests, euros); 
    			System.out.println("date: "+dates[5]+"	"+x[5]);
    			System.out.print(Stats.getvol(x));
    	*/
    	...
    	//System.out.println("the best single company to invest in is "+names[bestindex]+" with a lone volatility of "+sds[bestindex]);
    	//System.out.print("so lets start from "+names[bestindex]+" and work our way up to our max");
    	
    	invests[bestindex]=1;
    	//invests[]=1;
    	double[] x=Stats.getSumProd(data, invests, euros);
    	double v = Stats.getvol(x);
    	...
    	while(i<=maxinvest&&found)
    	{
    		...
    		if(found)
    		{
	    		...
	    		v=vt;
	    		i = Stats.getcurrinvest(euros, invests);
	    		System.out.println(bestinvest+" shares into " +names[bestcomp]+" gives "+v);
    		}    		
    	}	    	
